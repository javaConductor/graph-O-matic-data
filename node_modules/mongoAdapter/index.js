...
//        f = callbackWithReport("mongoAdapter.getViewTypes()", f);
        model.ViewType.find({})
            .exec(function (err, saved) {
                console.dir(['getViewTypes :',saved]);
    ...
    this.saveItem = function ( itmP  ) {
        ...
        q.when(itmP, function(itm){
            ...
            item.save(function ( err, i ) {
                (err) ? d.reject("mongoAdapter.saveItem Error:"+err) : d.resolve( afterRead.item(i));
            });
        });
        return d.promise;
    };
...
//    this.saveContext = (this.saveContextAsync);
  ...
  //  this.saveView = (this.saveViewAsync);
