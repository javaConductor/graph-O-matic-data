...
(function (mongoose, model, extend) {
	...
	this.debug = function(txt){ txt = txt || ""; console.log("Debug: "+ txt);}
	...
	this.callbackWithReport= function(label, f){
		return function(err, data){
			if (err || !data){
				console.error([
					"Call to "+label+" returned error >>" + JSON.stringify(err, null, '\t')
				]);
			}
//			else
//				console.dir([
...
//				]);
	...
	this.updateRelationshipType = function(rtype, f){
		...
		console.log("mongoAdapter.updateRelationshipType("+ JSON.stringify( rtype)+")");
	...
	this.updateItemType = function(itype, f){
		...
		console.log("mongoAdapter.updateItemType("+ JSON.stringify( itype )+")");
