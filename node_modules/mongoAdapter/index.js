...
(function (wu, mongoose, model, extend, logger) {
    ...
    this.saveViewType = function(it, f){
        ...
        var viewType = new model.ViewType(it);
...
searchOptions =>
{
    matchAll:true, // all search items must be found
    typeConstraints:[ ],// matches items of this type and children of this type
    relationshipConstraints:[],// not sure about this
    categoryConstraints:[],// matches items of this type and children of this type
}
...
})(require('wu'),require('mongoose'),require("./model.js"), require("xtend"), require('./logger.js'));
