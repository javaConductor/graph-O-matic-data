...
//    this.getContext = q.denodeify(this.getContextAsync);
...
//    this.saveContext = q.denodeify(this.saveContextAsync);
    ...
    //this.getView = q.denodeify(this.getViewAsync);
    ...
    //this.getViews = q.denodeify(this.getViewsAsync);
  ...
  //  this.saveView = q.denodeify(this.saveViewAsync);
...
//    this.updateView = q.denodeify(this.updateViewAsync);

    /////////// EXPORTS ////////////
    /////////// EXPORTS ////////////

    exports.saveCategory = q.denodeify(this.saveCategory);
    exports.getCategory = q.denodeify(this.getCategory);
    exports.getCategories = q.denodeify(this.getCategories);

    exports.saveRelationshipType = q.denodeify(this.saveRelationshipType);
    exports.updateRelationshipType = q.denodeify(this.updateRelationshipType);
    exports.getRelationshipType = q.denodeify(this.getRelationshipType);
    exports.getRelationshipTypes = q.denodeify(this.getRelationshipTypes);
    exports.getRelationshipTypeById = q.denodeify(this.getRelationshipTypeById);

    exports.saveRelationship = q.denodeify(this.saveRelationship);;
    exports.getRelationship = q.denodeify(this.getRelationship);;

    exports.saveItemType = q.denodeify(this.saveItemType);
    exports.getItemType = q.denodeify(this.getItemType);
    exports.updateItemType = q.denodeify(this.updateItemType);
    exports.getItemTypes = q.denodeify(this.getItemTypes);
    exports.getItemTypeById = q.denodeify(this.getItemTypeById);
    exports.getItemTypeByName = q.denodeify(this.getItemTypeByName);

    exports.saveItem = q.denodeify(this.saveItem);
    exports.getItems = q.denodeify(this.getItems);
    exports.getItem = q.denodeify(this.getItem);
    exports.deleteItem = q.denodeify(this.deleteItem);

    exports.saveViewItem = q.denodeify(this.saveViewItem);
    exports.getViewItem = q.denodeify(this.getViewItem);
    exports.updateViewItemPosition = q.denodeify(this.updateViewItemPosition);

    exports.saveViewType = q.denodeify(this.saveViewType);
    exports.getViewType = q.denodeify(this.getViewType);
    exports.getViewTypes = q.denodeify(this.getViewTypes);

    exports.saveView = q.denodeify(this.saveView);
    exports.getView = q.denodeify(this.getView);
    exports.getViews = q.denodeify(this.getViews);
    exports.updateView = q.denodeify(this.updateView);

    exports.getContext = q.denodeify(this.getContext);
    exports.saveContext = q.denodeify(this.saveContext);
