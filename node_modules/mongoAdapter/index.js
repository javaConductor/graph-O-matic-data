...
(function (wu, mongoose, model, extend, logger, q) {
    ...
    //////  ItemType  //////
    //////  ItemType  //////
    this.saveItemTypeOLD = function (it, f) {
...
//        f = callbackWithReport("mongoAdapter.saveItemType(" + JSON.stringify(it) + ")", f);
    ...
    this.getItemTypeByIdOLD = function (itypeId, f) {
...
//            .populate('properties.relationshipTypes')
    ...
    //////  Item  //////
    //////  Item  //////
    this.saveItemOLD = function ( itm, f ) {
        ...
        item.save(function ( err, i ) {
            (err) ? f(err) : f(null, afterRead.item(i));
        });
    };
    ...
    this.saveItem = function ( itmP  ) {
        ...
        q.when(itmP, function(itm){
            ...
            var item = new model.Item( itm );
            item.save(function ( err, i ) {
                (err) ? d.reject(err) : d.resolve( afterRead.item(i));
            });
        });
        return d.promise;
    };

    this.getItemold = function (itemId, f) {
